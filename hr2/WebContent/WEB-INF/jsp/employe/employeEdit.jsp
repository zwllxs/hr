...
<center>
	...
	<form id="form1" name="form1" action="<%=basePath%>employe/save2.do" method="post">
	<input type="hidden" name="id" value="${bean.id}"> <br>
	姓名:<input type="text" name="name" value="${bean.name}" style="width: 150px"> <br>
	userName:<input type="text" name="userName" value="${bean.userName}" style="width: 150px"> <br>
	realName:<input type="text" name="realName" value="${bean.realName}" style="width: 150px"> <br>
	desc:<input type="text" name="desc" value="${bean.desc}" style="width: 150px"> <br>
