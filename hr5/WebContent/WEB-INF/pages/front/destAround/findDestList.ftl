...
<div class="p_box">
<form method="post" action='/vst_back/front/destAround/findDestList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
...
$("a.editDestAround").bind("click",function(){
	...
	var url = "/vst_back/front/destAround/showAddAndUpdateDestAround.do?destId="+destId;
	addAndUpdateDialog = new xDialog(url,{},{title:"编辑"+destName+":第2目的地",width:900,height:500});
