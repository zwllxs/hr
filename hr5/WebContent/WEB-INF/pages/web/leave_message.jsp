...
<!DOCTYPE html>
<!-- saved from url=(0038)http://www.zwllxs.icoc.cc/msgBoard.jsp -->
...
<div id="memberBarArea" class="memberBarArea g_editPanel">
	...
	<div id="g_main" class="g_main g_col9 " style="top: 25px; width: 1263px; ">
...
<div class="itemSep"></div><table class="item itemCol9 itemIndex5 itemSelected itemSelectedIndex5" cellpadding="0" cellspacing="0" colid="9" id="nav9" onclick="document.location.href=&quot;/msgBoard.jsp&quot;" _jump="document.location.href=&quot;/msgBoard.jsp&quot;">
<tbody><tr>
<td class="itemLeft"></td>
<td class="itemCenter"><a hidefocus="true" style="outline:none;" href="res/css/中威尔软件_留言.htm" onclick="return false;"><span class="itemName0">留言板</span></a></td>
<td class="itemRight"></td>
</tr>
</tbody></table>
</div>
...
<div class="clearfloat clearfloat333"></div>
							...
							<td valign="top" id="containerFormsCenter" class="containerFormsCenter">
								...
								<div id="centerTopForms" class="column forms mainForms centerTopForms">
									<div id="module15" _indexclass="formIndex1" class="form form15 formIndex1 formStyle50 modulePattern modulePattern73" title="" style="" _side="0" _intab="0" _inmulmcol="0" _autoheight="1" _global="false" _independent="false">
<table class="formTop formTop15" cellpadding="0" cellspacing="0"><tbody><tr><td class="left"></td><td class="center"></td><td class="right"></td></tr></tbody></table>
<table class="formBanner formBanner15" cellpadding="0" cellspacing="0"><tbody><tr>
<td class="left left15"></td>
<td class="center center15" valign="top">
<table cellpadding="0" cellspacing="0" class="formBannerTitle formBannerTitle15"><tbody><tr>
<td class="titleLeft titleLeft15" valign="top">
</td>
<td class="titleCenter titleCenter15" valign="top">
<div class="titleText titleText15"><span>
留言板</span></div>
</td>
<td class="titleRight titleRight15" valign="top">
</td>
</tr></tbody></table>
</td>
<td class="right right15"></td>
</tr></tbody></table>
<table class="formMiddle formMiddle15" cellpadding="0" cellspacing="0"><tbody><tr>
<td class="formMiddleLeft formMiddleLeft15"></td>
<td class="formMiddleCenter formMiddleCenter15" valign="top">
...
<div style="height:23px; line-height:23px;width:210px;float:left;margin-bottom:4px;"><table cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">姓名：</div></td><td><input class="g_itext msg_ipt msg_isMust" id="reqName" name="姓名" type="text" size="14" maxlength="50"><font style="color:red;margin-left:5px">*</font></td></tr></tbody></table></div>
<div style="height:23px; line-height:23px;width:210px;float:left;margin-bottom:4px;"><table cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">电子邮件：</div></td><td><input class="g_itext msg_ipt" id="reqEmail" name="电子邮件" type="text" size="14" maxlength="50"></td></tr></tbody></table></div>
<div style="height:23px; line-height:23px;width:210px;float:left;margin-bottom:4px;"><table cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">联系电话：</div></td><td><input class="g_itext msg_ipt" id="reqPhone" name="联系电话" type="text" size="14" maxlength="50"></td></tr></tbody></table></div>
<div style="height:24px; line-height:24px; width:210px;float:left;margin-bottom:4px;"><table cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">验证码：</div></td><td><div style="width:180px"><div style="float:left;"><input class="g_itext" id="msgBoardCaptcha" style="width:40px" type="text" maxlength="4"></div><div style="float:left;"><img alt="" onclick="Site.changeMsgBoardValidateCode()" title="看不清，换一张" id="msgBoardCaptchaImg" style="height:24px;width:80px;cursor:pointer" src="res/images/validateCode.jsp"></div></div></td></tr></tbody></table></div>
</div>
<div class="msgAddText"><div style="margin-bottom:4px;"><table width="100%" cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">内容：</div></td><td><div><textarea class="g_textarea" id="reqContent" rows="3" cols="50" style="width:87%;" maxlength="200"></textarea>
</div></td></tr></tbody></table></div>
<div class="msgAddButton">
<table width="100%" cellpadding="0" cellspacing="0"><tbody><tr><td width="60px"><div class="msgBoard_overToPoint">&nbsp;</div></td><td><div style=""><input class="g_ibutton" extclass="g_ibutton" type="button" onclick="Site.msgBoardAddMsg()" value="提交留言">
<span class="g_minor" style="float:left;padding-left:5px;_float:none;">留言需管理员审核后才会在网页中显示</span>
</div></td></tr></tbody></table></div>
</div>
</div>
...
<table class="formBottom formBottom15" cellpadding="0" cellspacing="0"><tbody><tr><td class="left left15"></td><td class="center center15"></td><td class="right right15"></td></tr></tbody></table>
...
<div class="floatRightBottom">
	<div id="floatRightBottomForms" class="forms sideForms floatForms">
		<div id="module37" _indexclass="formIndex1" class="form  formIndex1 formStyle67" title="" style="position: absolute; top: -376px; left: -0.289180832699824px; width: 180px; overflow: visible; " _side="1" _intab="0" _inmulmcol="0" _autoheight="1" _global="true" _independent="false">
...
$(function() {
	...
	// ajax统计
	Site.total({colId:9, pdId:-1, ndId:-1, sc:0, rf:"http://www.zwllxs.icoc.cc/col.jsp?id=101"});
