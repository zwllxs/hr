                ...
                <table class="e_table form-inline">
	                ...
	                <tr>
						...
						<td>
		                    ...
		                    </select><span style="color:grey">说明：由高到低排列，即数字越高推荐级别越高。</span></label>
	                    </td>
	                </tr>
	                <tr>
						<td class="e_label"><i class="cc1">*</i>目的地：</td>
			            <td>
			            	<input type="text" id="dest" readonly = "readonly" required>
			            	<input type="hidden" name="prodDestReList[0].destId" id="destId" >
...
var busiSelectIndex;//酒店业务字典
	...
	$("#save").click(function(){
    	...
    	var loading = top.pandora.loading("正在努力保存中...");		
			$.ajax({
				url : "/vst_back/singleTicket/prod/product/addProduct.do",
				type : "post",
				dataType : 'json',
				...
				success : function(result) {
					...
					if(result.code == "success"){
						...
						pandora.dialog({wrapClass: "dialog-mini", content:result.message,okValue:"确定",mask:true,ok:function(){
							...
							//window.location = "/vst_back/singleTicket/prod/prodbranch/findProductBranchList.do?productId="+productId+"&categoryId="+categoryId;
						}});
