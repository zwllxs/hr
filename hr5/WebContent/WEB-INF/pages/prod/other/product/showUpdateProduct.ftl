...
<form action="/vst_back/other/prod/product/addProduct.do" method="post" id="dataForm">
...
jQuery.validator.addMethod("isCharCheck", function(value, element) {
	...
	$("#save").bind("click",function(){
		...
		$.confirm(msg,function(){
			...
			$.ajax({
				url : "/vst_back/other/prod/product/updateProduct.do",
				type : "post",
				dataType : 'json',
		...
		$.confirm(msg, function () {
			...
			$.ajax({
				...
				success : function(result) {
					...
					window.location.href="/vst_back/other/prod/prodbranch/findProductBranchList.do?productId="+productId+"&categoryId="+categoryId;
				},
				error : function(result) {
					loading.close();
					$.alert(result.message);
