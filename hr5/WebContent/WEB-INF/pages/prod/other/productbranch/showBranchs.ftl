...
$("#new_button").bind("click",function(){
		...
		dialog("/vst_back/other/prodbranch/showAddProductBranch.do?branchId="+branchId+"&productId="+productId, "新增产品规格",800,"auto",function(){
        ...
        var resultCode;
		$.ajax({
			url : "/vst_back/other/prodbranch/addProductBranch.do",
			type : "post",
			async: false,
