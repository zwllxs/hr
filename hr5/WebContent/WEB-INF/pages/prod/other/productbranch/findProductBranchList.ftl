...
$("a.editProp").bind("click",function(){
	...
	updateDialog = new xDialog("/vst_back/other/prod/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId,"productId":productId}, {title:"修改产品规格",width:900});
});
...
$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	 	 $.get("/vst_back/other/prod/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
$("li a").bind("click",function(){
	...
	var productId = ${productId!''}; 
	addDialog = new xDialog("/vst_back/other/prod/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId}, {title:"新增产品规格",width:900})
});
