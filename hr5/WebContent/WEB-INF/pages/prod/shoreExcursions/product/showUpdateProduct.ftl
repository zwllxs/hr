...
<form action="/vst_back/prod/shoreExcursions/addProduct.do" method="post" id="dataForm">
...
$(function(){
	...
	$("#save").bind("click",function(){
    		...
    		$.confirm("确认修改吗 ？",function(){
				...
				refreshAddValue();
				$.ajax({
					url : "/vst_back/prod/shoreExcursions/updateProduct.do",
					type : "post",
					dataType : 'json',
	...
	$("#saveAndNext").bind("click",function(){
			...
			$.ajax({
				...
				success : function(result) {
					...
					window.location.href="/vst_back/prod/shoreExcursions/showSuppGoodsList.do?productId="+productId;
