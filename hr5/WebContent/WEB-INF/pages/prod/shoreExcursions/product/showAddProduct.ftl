            ...
            <div class="box_content">
                <table class="e_table form-inline">
	                ...
	                <tr>
	                    ...
	                    <td><label><input type="text" class="w35" style="width:700px" maxLength="50" name="productName" id="productName" required>&nbsp;请勿输入下列字符    <> % # * & ^ @ ! ~ / \ '|| -"</label>
...
vst_pet_util.superUserSuggest("#managerName", "input[name=managerId]");
	...
	$("#save").click(function(){
		...
		refreshAddValue();
			$.ajax({
				url : "/vst_back/prod/shoreExcursions/addProduct.do",
				type : "post",
				dataType : 'json',
				...
				success : function(result) {
					...
					if(result.code == "success"){
						...
						pandora.dialog({wrapClass: "dialog-mini", content:result.message, okValue:"确定",ok:function(){
							...
							window.location = "/vst_back/prod/shoreExcursions/showSuppGoodsList.do?productId="+productId+"&categoryId="+categoryId;
						}});
