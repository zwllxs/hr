...
var busiSelectIndex;//酒店业务字典
	...
	$("#save").click(function(){
    	...
    	var loading = top.pandora.loading("正在努力保存中...");		
			...
			$.ajax({
				url : "/vst_back/otherTicket/prod/product/addProduct.do",
				type : "post",
				dataType : 'json',
				...
				success : function(result) {
					...
					if(result.code == "success"){
						...
						pandora.dialog({wrapClass: "dialog-mini", content:result.message, okValue:"确定",mask:true,ok:function(){
							...
							window.location = "/vst_back/otherTicket/prod/prodbranch/findProductBranchList.do?productId="+productId+"&categoryId="+categoryId;
						}});
