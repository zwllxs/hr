...
<!-- 主要内容显示区域\\ -->
				<div>
	                	<form method="post" action='/vst_back/otherTicket/prod/prodbranch/findProductBranchList.do' id="searchForm">
...
var addDialog,updateDialog;
	...
	$("a.editProp").bind("click",function(){
		...
		updateDialog = new xDialog("/vst_back/otherTicket/prod/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId, "categoryId":categoryId}, {title:"修改产品规格",width:900});
});
	...
	$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	  $.get("/vst_back/otherTicket/prod/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
//新建
	...
	$("li a").bind("click",function(){
		...
		var categoryId = ${categoryId!''}; 
		addDialog = new xDialog("/vst_back/otherTicket/prod/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId, "categoryId":categoryId}, {title:"新增产品规格",width:900})
		});
