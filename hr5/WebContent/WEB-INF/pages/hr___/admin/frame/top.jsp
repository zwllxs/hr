...
<HEAD>
	...
	<LINK TYPE="text/css" REL="stylesheet" HREF="${basePath}/res/css/blue/top.css" />
</HEAD>
	...
	<DIV ID="Head1">
		...
		<DIV ID="Head1Right">
			<DIV ID="Head1Right_UserName">
                <IMG BORDER="0" WIDTH="13" HEIGHT="14" SRC="${basePath}/res/css/images/top/user.gif" /> 您好，<B>管理员</B>
			</DIV>
			<DIV ID="Head1Right_UserDept"></DIV>
			<DIV ID="Head1Right_UserSetup">
            	<A HREF="javascript:void(0)">
					<IMG BORDER="0" WIDTH="13" HEIGHT="14" SRC="${basePath}/res/css/images/top/user_setup.gif" /> 个人设置
				</A>
			</DIV>
        ...
        <DIV ID="Head1Right_SystemButton">
            <A TARGET="_parent" HREF="System_User/logout.html">
				<IMG WIDTH="78" HEIGHT="20" ALT="退出系统" SRC="${basePath}/res/css/blue/images/top/logout.gif" />
			</A>
        </DIV>
		
        <DIV ID="Head1Right_Button">
            <A TARGET="desktop" HREF="/desktop?method=show">
				<IMG WIDTH="65" HEIGHT="20" ALT="显示桌面" SRC="${basePath}/res/css/blue/images/top/desktop.gif" />
			</A>
        </DIV>
	</DIV>
        ...
        <DIV ID="Head2_Awoke">
            <UL ID="AwokeNum">
                <LI><A TARGET="desktop" HREF="javascript:void(0)">
						<IMG BORDER="0" WIDTH="11" HEIGHT="13" SRC="${basePath}/res/css/images/top/msg.gif" /> 消息
						<SPAN ID="msg"></SPAN>
					</A>
				</LI>
                <LI CLASS="Line"></LI>
                <LI><A TARGET="desktop" HREF="javascript:void(0)">
						<IMG BORDER="0" WIDTH="16" HEIGHT="11" SRC="${basePath}/res/css/images/top/mail.gif" /> 邮件
						<SPAN ID="mail"></SPAN>
					</A>
				</LI>
                <LI CLASS="Line"></LI>
                ...
                <LI><A HREF="Flow_Formflow/myTaskList.html" TARGET="desktop">
                		<IMG BORDER="0" WIDTH="12" HEIGHT="14" SRC="${basePath}/res/css/images/top/wait.gif" /> 
