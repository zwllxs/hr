...
<script language="JavaScript" src="${basePath}/res/admin/js/menu.js"></script>
<link type="text/css" rel="stylesheet"
	href="${basePath}/res/admin/css/blue/menu.css" />
<script type="text/javascript">
	var basePath = "";
	var SubImg = '${basePath}/res/admin/css/images/MenuIcon/menu_arrow_close.gif';
	var SubImgOpen = '${basePath}/res/admin/css/images/MenuIcon/menu_arrow_open.gif';
</script>
</head>
<body style="margin: 0">
	<div id="Menu">
		<ul id="MenuUl">
			<li class="level1">
				<div onClick="menuClick(this);" id="MEMU_FUNC20057"
					...
					<img src="${basePath}/res/admin/css/images/MenuIcon/FUNC20057.gif"
						class="Icon" /> 审批流转
				</div>
				<ul style="display: none;" id="MEMU_FUNC20057_d" class="MenuLevel2">
					<li class="level2">
						<div class="level2Style">
							<img
								src="${basePath}/res/admin/css/images/MenuIcon/menu_arrow_single.gif"
			...
			<li class="level1">
				<div onClick="menuClick(this);" style="cursor: pointer;"
					...
					<img src="${basePath}/res/admin/css/images/MenuIcon/FUNC20064.gif"
						class="Icon" /> 网上交流222
				</div>
				<ul style="display: none;" id="MEMU_FUNC20064_d" class="MenuLevel2">
					<li class="level2">
						<div onClick="subMenuClick(this);" id="MEMU_FUNC20002"
							...
							<img
								src="${basePath}/res/admin/css/images/MenuIcon/menu_arrow_close.gif"
