...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../res/admin/css/blue/pageCommon.css" />
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="../res/admin/css/images/title_arrow.gif"/> 我的申请查询
        </div>
	...
	<div style="height: 30px">
		...
		<table border=0 cellspacing=3 cellpadding=5>
			<tr>
				...
				<td><a href=""><input type="IMAGE" src="../res/admin/css/blue/images/button/query.PNG"/></a></td>
			</tr>
		</table>
		</form>
	</div>
...
<div id=PageSelectorBar>
	...
	<div id=PageSelectorSelectorArea>
		<!--
		<IMG SRC="../res/admin/css/blue/images/pageSelector/firstPage2.png"/>
		-->
		<a href="javascript:void(0)" title="首页" style="cursor: hand;">
			<img src="../res/admin/css/blue/images/pageSelector/firstPage.png"/></a>
		...
		<!--
		<IMG SRC="../res/admin/css/blue/images/pageSelector/lastPage2.png"/>
		-->
		<a href="#" title="尾页" style="cursor: hand;">
			<img src="../res/admin/css/blue/images/pageSelector/lastPage.png"/></a>
