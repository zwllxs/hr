        ...
        <table class="p_table form-inline">
            <tbody>
                ...
                <tr>
					...
					<td colspan=2>
						<select name="lvmamaFlag" required>
                ...
                <tr>
					...
					<td colspan=2>
						<select name="distributeFlag" required>
                ...
                <tr>
					<td class="p_label"><i class="cc1">*</i>最少入住天数：</td>
					<td colspan=2>
						<select name="minStayDay" class="w10">
						<#list 0..100 as i>
		                      <option value="${i}" <#if suppGoods!=null && suppGoods.minStayDay==i>selected</#if>>${i}</option>
                        </#list>
						</select>
                    </td>
                </tr>
                <tr>
					<td class="p_label"><i class="cc1">*</i>最多入住天数：</td>
					<td colspan=2>
						<select name="maxStayDay" class="w10">
						<#list 0..365 as i>
		                      <option value="${i}" <#if suppGoods!=null && suppGoods.maxStayDay==i>selected</#if> >${i}</option>
                        </#list>
						</select>
                    </td>
                </tr>
	...
	$(function(){
		...
		$("#update").bind("click",function(){
			...
			$.confirm(msg,function(){
				$.ajax({
					url : "/vst_back/goods/goods/updateSuppGoods.do",
					type : "post",
