...
<div class="iframe_content mt10">
        ...
        <form method="post" action='/vst_back/other/goods/findSuppGoodsList.do' id="searchForm">
...
$("#new_button").bind("click",function(){
	...
	if($("#supplierId").val()!=null && $("#supplierId").val()!=""){	
		addSuppGoodsDialog = new xDialog("/vst_back/other/goods/showAddSuppGoods.do",{productId:$("input[name='prodProduct.productId']").val(),supplierId:$("#supplierId").val(),contractName:$("#contractName").val(),
...
$("a.editProp").bind("click",function(){
	...
	updateSuppGoodsDialog = new xDialog("/vst_back/other/goods/showUpdateSuppGoods.do",{suppGoodsId:suppGoodsId,productId:$("input[name='prodProduct.productId']").val(),
...
$("a.cancelProp").bind("click",function(){
	...
	$.ajax({
		url : "/vst_back/other/goods/cancelGoods.do",
		type : "post",
		dataType:"JSON",
