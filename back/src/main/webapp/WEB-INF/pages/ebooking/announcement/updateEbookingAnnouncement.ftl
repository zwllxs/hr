	<form id="updateAnnouncement" method="post" enctype="multipart/form-data">
		...
		<table>
			<tr height="26">
				...
				<td><input class="ggbt_w330" type="text" name="title"
					value="${announcement.title}" maxlength="150" required=true/></td>
			</tr>
			<tr>
				<td>公告内容:</td>
				<td><textarea id="contentA" style="width: 600px; height: 300px;" class="ckeditor">${announcement.content}</textarea>
			...
			<tr height="26">
				...
				<td>
				<input type="text" name="beginTime" value="${announcement.beginDate?string("yyyy-MM-dd HH:mm:ss")}" required=true id="defaultInput" class="Wdate" id="defaultInput" onFocus="WdatePicker({readOnly:true, dateFmt:'yyyy-MM-dd HH:mm:ss'})">
