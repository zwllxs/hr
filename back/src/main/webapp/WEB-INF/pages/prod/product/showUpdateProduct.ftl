       ...
       <div class="p_box box_info p_line">
            ...
            <tbody>
				...
				<tr>
                    ...
                    <td>
                    	<label><input type="text" class="w35" style="width:700px" name="productName" id="productName" value="${prodProduct.productName}" required>&nbsp;请勿输入下列字符    <> % # * & ^ @ ! ~ / \ '||"</label>
...
$(function(){
	...
	$("#save").bind("click",function(){
    	...
    	$.confirm(msg,function(){
			...
			refreshAddValue();
			$.ajax({
				url : "/vst_back/prod/product/updateProduct.do",
				type : "post",
				dataType : 'json',
