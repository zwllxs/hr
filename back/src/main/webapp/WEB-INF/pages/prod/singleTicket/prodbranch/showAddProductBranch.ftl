                    ...
                    <table class="e_table form-inline ">
                        <tbody>
			                ...
			                <tr>
			                    ...
			                    <td><label><input type="text" name="branchName" id="branchName" required=true maxlength="50" class="w35"></label>
			                     <span style="color:grey">填写项目的名称。</span>
			                     </td>
			                </tr>    
			               <tr>
	...
	$("#save").bind("click",function(){
		 ...
		 if(refreshSensitiveWord($("input[type='text'],textarea"))){
			...
			$.confirm(msg,function(){
				...
				$.ajax({
				url : "/vst_back/singleTicket/prod/prodbranch/addProductBranch.do",
				type : "post",
				dataType:"json",
				async: false,
				...
				success : function(result) {
				     ...
				     if(result.code=="success"){
							$.alert(result.message,function(){
									location.href="/vst_back/singleTicket/prod/prodbranch/findProductBranchList.do?productId=${productId!''}&categoryId=${categoryId!''}";
					   				addDialog.close();
			   				});
					 }else {
