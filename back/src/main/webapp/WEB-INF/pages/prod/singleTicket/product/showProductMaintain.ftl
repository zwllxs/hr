    ...
    <div class="pg_aside">
        <div class="aside_box">
            ...
            <ul class="pg_list J_list">
                ...
                <li class="cc1"><a target="iframeMain" href='javascript:void(0);' id="productActivity">景区活动</a></li>
                <li class="cc1"><a target="iframeMain" href='javascript:void(0);' id="productFeature">景区特色</a></li>
                <li class="cc1"><a target="iframeMain" href='javascript:void(0);' id="productViewSpot">游玩景点</a></li>
            ...
            <ul class="pg_list J_list">           		
                ...
                <li class="cc1"><a 	target="iframeMain" href='javascript:void(0);'  id="prodServiceRe">设置服务保障</a></li>
            </ul>
        </div>
    </div>
    <!-- //工作区 -->
...
<script>
	...
	$(document).ready(function(){
	 ...
	 var $LI = $(".J_list").find("li"), 
		...
		// 游玩景点
		$("#productViewSpot").parent("li").click(function(){
			var productId = $("#productId").val();
				...
				success : function(result) {
					if(result.code == "error"){
						$.alert(result.message);
					 	...
					 	$("#iframeMain").attr("src","/vst_back/singleTicket/prod/prodViewSpot/findProdViewSpotList.do?productId="+productId+"&categoryId="+categoryId);
					}
				},
		...
		// 景区特色
		$("#productFeature").parent("li").click(function(){
			var productId = $("#productId").val();
			var categoryId = $("#categoryId").val();
			if(productId==""){
				$.alert("请先创建产品");
				...
				success : function(result) {
					if(result.code == "error"){
						$.alert(result.message);
					 	...
					 	$("#iframeMain").attr("src","/vst_back/singleTicket/prod/prodFeature/findProdFeatureList.do?productId="+productId+"&categoryId="+categoryId);
					}
				},
				error : function(result) {
					$.alert(result.message);
		...
		// 景区活动
		$("#productActivity").parent("li").click(function(){
			var productId = $("#productId").val();
			var categoryId = $("#categoryId").val();
			if(productId==""){
				$.alert("请先创建产品");
				...
				success : function(result) {
					if(result.code == "error"){
						$.alert(result.message);
					 	...
					 	$("#iframeMain").attr("src","/vst_back/singleTicket/prod/prodActivity/findProdActivityList.do?productId="+productId+"&categoryId="+categoryId);
					}
				},
				error : function(result) {
					$.alert(result.message);
				...
				success : function(result) {
					if(result.code == "error"){
						...
						$(".pg_title").html("修改产品"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"产品名称："+$("#productName").val()+"   "+"品类:"+$("#categoryName").val()+"   "+"产品ID："+$("#productId").val());
					 	$("#iframeMain").attr("src","/vst_back/singleTicket/prod/prodbranch/findProductBranchList.do?productId="+productId+"&categoryId="+categoryId);
					}
				},
				error : function(result) {
					$.alert(result.message);
		...
		// 设置服务保障
		$("#prodServiceRe").parent("li").click(function(){
			var productId = $("#productId").val();
			var categoryId = $("#categoryId").val();
			if(productId==""){
				$.alert("请先创建产品");
			...
			$.ajax({
				...
				success : function(result) {
					if(result.code == "error"){
						...
						$(".pg_title").html("修改产品"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"产品名称："+$("#productName").val()+"   "+"品类:"+$("#categoryName").val()+"   "+"产品ID："+$("#productId").val());
					 	$("#iframeMain").attr("src","/vst_back/singleTicket/prod/prodServiceRe/showProdServiceRe.do?productId="+productId+"&categoryId="+categoryId+"&no-cache="+Math.random());
					}
				},
				error : function(result) {
					$.alert(result.message);
	...
	function checkAndJump(){
		...
		//打开选择品类
		if(productId==""){
			$("#iframeMain").attr("src","/vst_back/singleTicket/prod/product/showAddProduct.do?categoryId="+categoryId+"&timestamp="+Math.random(10));
		}else{
			$(".pg_title").html("修改产品"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"产品名称："+$("#productName").val()+"   "+"品类:"+$("#categoryName").val()+"   "+"产品ID："+$("#productId").val());
		    $("#iframeMain").attr("src","/vst_back/singleTicket/prod/product/showUpdateProduct.do?productId="+productId+"&timestamp="+Math.random(10));
		}
	}
	...
	$("#suppGoods").parent("li").click(function(){
		if($("#productId").val()!=null && $("#productId").val()!=""){
			$.ajax({
				url : "/vst_back/ticket/goods/goods/showSuppGoodsListCheck.do?productId="+$("#productId").val(),
				type : "post",
				async: false,
				dataType : 'json',
				success : function(result) {
					if(result.code == "error"){
						...
						$(".pg_title").html("修改产品"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"产品名称："+$("#productName").val()+"   "+"品类:"+$("#categoryName").val()+"   "+"产品ID："+$("#productId").val());
					 	$("#iframeMain").attr("src","/vst_back/ticket/goods/goods/showSuppGoodsList.do?productId="+$("#productId").val());
					}
				},
				error : function(result) {
					$.alert(result.message);
