		...
		<div class="p_box box_info p_line">
            <div class="box_content">
                <table class="e_table form-inline">
					...
					<tr>
	                	<td class="e_label"><i class="cc1">*</i>邮轮中文名称：</td>
					...
					<tr>
	                    ...
	                    <td><label><input type="text" class="w35" style="width:700px" name="urlId" id="urlId" required=true maxlength="50">&nbsp;请只输入大小写英文字母</label>
	                ...
	                <tr>
						...
						<td>
							<label><select name="recommendLevel" required>
		                    	...
		                    	<option value="5" selected="selected">2</option>
	...
	$("#save").click(function(){
		...
		//遮罩层
    	   var loading = top.pandora.loading("正在努力保存中...");		
			...
			$.ajax({
				url : "/vst_back/ship/prod/product/addProduct.do",
				type : "post",
				dataType : 'json',
					...
					success : function(result) {
						...
						if(result.code == "success"){
							...
							pandora.dialog({wrapClass: "dialog-mini", content:result.message, okValue:"确定",ok:function(){
								...
								window.location = "/vst_back/ship/prod/prodbranch/findProductBranchList.do?productId="+productId+"&categoryId="+categoryId;
							}});
							$(".pg_title", parent.document).html("修改产品"+"&nbsp;&nbsp;&nbsp;&nbsp;"+"产品名称："+$("input[name='productName']").val()+"   "+"品类:"+$("#categoryName",window.parent.document).val()+"   "+"产品ID："+$("input[name='productId']").val());
						}else {
							$.alert(result.message);
						}
					},
