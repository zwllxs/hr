...
<!-- 主要内容显示区域\\ -->
				<div>
	                	<form method="post" action='/vst_back/ship/prod/prodbranch/findProductBranchList.do' id="searchForm">
...
var addDialog,updateDialog;
	...
	$("a.editProp").bind("click",function(){
		...
		updateDialog = new xDialog("/vst_back/ship/prod/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId}, {title:"修改产品规格",width:900});
});
	...
	$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	  $.get("/vst_back/ship/prod/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
//新建
	...
	$("li a").bind("click",function(){
		...
		addDialog = new xDialog("/vst_back/ship/prod/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId}, {title:"新增产品规格",width:900})
		});
</script>
