...
<div class="tiptext tip-warning cc5"><span class="tip-icon tip-icon-warning"></span>友情提示：
    ...
    -->
<div class="p_box">
<form method="post" action='/vst_back/goods/shoreExcursions/showGoodsTimePrice.do' id="searchForm">
...
<script>
	...
	$("#timePriceSaveButton").click(function(){
		...
		*/
		...
		$.ajax({
			url : "/vst_back/goods/shoreExcursions/editGoodsTimePrice.do",
       ...
       $("#cancelFlag").change(function(){
 		...
 		$("input[type=radio][name=good]").click(function () {
				...
				$("#timePriceDiv").html("");
	         	...
	         	//alert(data);
	         	$.post("/vst_back/goods/shoreExcursions/findSuppSingleTimePriceList.do",
				   data,
				   function(result){
